...
//        e.g https://github.com/indurekha73/events-app-web-server.git might become https://github.com/MyName/external.git
// variables:
    ...
    stages {
        stage('Get Source') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/indurekha73/events-app-web-server.git'
